...
const Signin = () => {
    ...
    const { setEmail, setPassword, sign_in, isLoading, errors } = useAuth();
  return (
    <main>
      <section>
        <div>
        ...
        <div className="mx-5 pt-[10rem]">
          <div className="flex justify-center">
            ...
            <Card className="w-[30rem] p-5 shadow-none">
              ...
              <div className="flex justify-center">
                { !isLoading && <Button className="bg-[#ff0000] px-[12rem] my-4 text-white rounded" onClick={sign_in}>
                  Sign Up
                </Button> }
              ...
              <p className="text-center text-gray-400">Don't have an account? <Link to="/signup" className="text-[#ff0000] font-bold">Sign Up</Link></p>
            </Card>
            </div>
          </div>
        </div>
